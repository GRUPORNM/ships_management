		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#shipsmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"shipsmanagement-display": {
								"semanticObject": "shipsmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shipsmanagement",
									"url": sap.ui.require.toUrl("shipsmanagement")
								}
							}
						}
					}
